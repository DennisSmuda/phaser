...
Game.Menu.prototype = {
  ...
  create: function() {
    ...
    var label = game.add.text(w/2, h/2-100, 'Snake Clone', { font: '60px Arial', fill: '#2c2c2c', align: 'center' });
    ...
    this.sound_toggle = this.game.add.button(w-50, 50, 'sound', this.toogle_sound, this);
